...
function webViewerInitialized() {
  ...
  // var ttt=queryString.split("file=")[1];
  // alert(ttt);
  // if(ttt===undefined){
  //     ttt = 'oa11';
  // }
  file = 'file' in params ? queryString.split("file=")[1] : _app_options.AppOptions.get('defaultUrl');
   // file = 'f' in params ? '/'+ttt+'/pdf?f='+params.f : _app_options.AppOptions.get('defaultUrl');
