	...
	<div>
		<el-card class='box-card'>
			<template #header>
				<el-row>
					<el-col :span='11'>
						<el-input v-model='state.form.name' placeholder='输入名称回车查询' clearable
											style='width: 200px;margin-right: 10px' @keyup.enter='listQuery(state)' />
			...
			<el-table height='400' :cell-style="{padding:'2px'}" :row-style="{height: '36px'}"
				...
				<el-table-column label='代理商名称' width='180'>
