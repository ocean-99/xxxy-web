	...
	<div>
		<el-card class='box-card'>
			<template #header>
				<el-row>
					<el-col :span='14'>
						<el-select v-model="state.form.catid" clearable placeholder="转换分类" style='margin-right:10px;width: 120px'>
							<el-option
			...
			<el-table height='400' :cell-style="{padding:'2px'}" :row-style="{height: '36px'}" v-loading='state.loading' :data='state.list'
				...
				<el-table-column label='转换名称' width='180'>
...
const state = reactive({
	url: '/te/tran/main', loading: true, ids: [],cates:[] as any,
