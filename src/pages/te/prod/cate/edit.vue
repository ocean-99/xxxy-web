			...
			<div style='padding: 20px;border-top: 1px solid #ccc'>
				<el-form ref='formRef' :model='form' label-width='160px'>
					<el-row style='height: 48px'>
						<el-col :span='12'>
							<el-form-item label='分类代码：' prop='id' :rules="[{ required: true, message: '代码不能为空'}]">
								<el-input v-model='form.id' :disabled='form.crtim?true:false'></el-input>
							</el-form-item>
						</el-col>
						<el-col :span='12'>
