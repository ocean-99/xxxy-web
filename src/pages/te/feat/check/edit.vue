<template>
	...
	<el-card class='box-card' :body-style="{padding:'2px 8px'}" shadow='never'>
		<template #header>
			<el-row>
				<el-col :span='10'>
					<div style='line-height: 32px'>特性校验</div>
				</el-col>
				...
				<el-tabs type='card' v-model='activeName'>
					<el-tab-pane label='基本信息' name='tab1'>
						<el-row style='border-top: 1px solid #d2d2d2;'>
							<el-col :span='12'>
								<el-form-item label='校验名称：' prop='name' :rules="[{ required: true, message: '名称不能为空'}]">
									<div class='zinput'>
							...
							<el-col :span='24'>
								<el-form-item label='校验规则：'>
									<div class='zinput' style='height: auto'>
										<el-input v-model='form.rule' type='textarea' :rows='6' placeholder='通过后台JS引擎调用JS代码片段，返回true或false' />
									</div>
								</el-form-item>
							</el-col>
						</el-row>
...
<script lang="ts">
export default {name: 'teFeatCheck'}
</script>
...
const state = reactive({
	url: '/te/feat/check',cates:[] as any,
	params: { path: '', query: '' },
