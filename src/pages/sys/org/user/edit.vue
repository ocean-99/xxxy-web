            ...
            <el-row style='border-top: 1px solid #d2d2d2;'>
              ...
              <el-col :span='6'>
                <el-form-item label='昵称：'>
                  <div class='zinput'>
                    <el-input v-model='form.ninam'></el-input>
                  </div>
                </el-form-item>
              </el-col>
              <el-col :span='6'>
                <el-form-item label='登录名：' prop='usnam' :rules="[{ required: true, message: '登录名不能为空'}]">
                  <div class='zinput'>
                    <el-input v-model='form.usnam'></el-input>
                  </div>
                </el-form-item>
              </el-col>
              <el-col :span='6'>
                <el-form-item label='密码：' prop='pacod' :rules="[{ required: true, message: '密码不能为空'}]">
                  <div class='zinput'>
                    <el-input type="password" v-model='form.pacod' show-password></el-input>
                  </div>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span='12'>
                <el-form-item label='所属部门：' prop='deptna' :rules="[{ required: true, message: '所属部门不能为空'}]">
                  <div class='zinput'>
                    <el-input v-model='form.deptna' @click='openOrgModal' readonly :suffix-icon='Search'></el-input>
                  </div>
                </el-form-item>
              </el-col>
              <el-col :span='6'>
            ...
            <el-row>
              ...
              <el-col :span='6'>
                <el-form-item label='手机号：'>
                  <div class='zinput'>
                    <el-input v-model='form.monum'></el-input>
                  </div>
                </el-form-item>
              </el-col>
              <el-col :span='6'>
