<template>
  <el-dialog v-model='state.show' title='模型组编辑' draggable width='500px'>
    <el-form ref='formRef' :model='form' label-width='120px'>
      <el-form-item label='组名称：' prop='name' :rules="[{ required: true, message: '组名不能为空'}]">
