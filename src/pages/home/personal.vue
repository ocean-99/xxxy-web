			...
			<div class="croppers-container" style='height: 100%;background-color: white'>
				<el-card shadow="hover" :body-style="{padding:'0'}" style='height: 100%'>
					<div class="cropper-img-warp">
						...
						<el-button type="primary" size="default" @click="uploadAvatar">
							<el-icon>
								<ele-Position/>
							</el-icon>
							上传
					...
					<div class="my-personal" style='margin-top: 10px;' >
						...
						>
							<el-sub-menu index="1">
								...
								<el-menu-item index="1-1" @click='item1Click'>账号管理</el-menu-item>
								<el-menu-item index="1-2" @click='item2Click'>收藏管理</el-menu-item>
							</el-sub-menu>
<!--							<el-sub-menu index="2" >-->
<!--								<template #title>-->
