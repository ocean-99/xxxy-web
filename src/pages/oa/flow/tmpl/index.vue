			...
			<el-card class='box-card'>
				<template #header>
					<div class='zjustify'>
						...
						<div>
							<el-button type='success' :icon='Plus' @click='pageAdd("ofte?catid="+state.form.catid+"&catna="+state.form.catna)' plain>新增</el-button>
...
<!--<script lang='ts'>-->
<!--export default { name: 'OaFlowTmpl' };-->
<!--</script>-->
...
const state = reactive({
	url: '/oa/flow/tmpl', loading: true, ids: [], moreParams: false,
	form: { catid: '', catna: '' }, single: true, multiple: true, list: [], total: 0,
});
