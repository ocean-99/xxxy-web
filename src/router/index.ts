...
import { staticRoutes, saDynamicRoutes } from '/@/router/route';
import { sysDynamicRoutes } from '/@/router/sysRoute';
...
function getDynamicRoutes(){
	...
	if(path=="/sys/"||path=="/sys"){
		return sysDynamicRoutes;
	}else{
		return saDynamicRoutes;
	}
}

const dynamicRoutes: Array<RouteRecordRaw>=getDynamicRoutes();
// const queryVal = getQueryValue('name');
// if (window.location.pathname == '/sys') {
// 	dynamicRoutes.children = sysDynamicRoutes.children;
// }
