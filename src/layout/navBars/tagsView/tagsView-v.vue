	...
	<div style="display: flex;">
        ...
        <span class="icon-span" @click="toRefreshPage">
           <el-icon class="el-input__icon" style="font-size: 18px;margin-top: 8px;margin-bottom: 8px;margin-right: 4px">
            <ele-RefreshRight :class="[isRotate? 'rotate-go':'rotate-none']"/>
          </el-icon>
        </span>
				<span class="icon-span" @click="toFullScreen">
          <el-icon class="el-input__icon" style="font-size: 18px;margin-top: 8px;margin-bottom: 8px;margin-right: 4px">
            <ele-FullScreen/>
          </el-icon>
        </span>
...
import { getCurrentInstance,defineAsyncComponent, reactive, onMounted, computed, ref, nextTick, onBeforeUpdate, onBeforeMount, onUnmounted, watch } from 'vue';
