<template>
  <el-form size="large" class="login-content-form">
    <el-form-item>
      <el-input text placeholder="用户名／手机号／邮箱" v-model="state.ruleForm.username" clearable autocomplete="off" >
        <template #prefix>
...
const onSignIn = async () => {
  ...
  const result:any=await useLoginApi().signIn({username:state.ruleForm.username,password:state.ruleForm.password}).catch(()=>{
    initLoading.close();
