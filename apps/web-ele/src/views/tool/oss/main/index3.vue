  ...
  <Page auto-content-height>
    <el-card class="box-card" style="height: 100%" body-style="height: 100%">
      <template #header>
        <div class="flex justify-between">
          ...
          <el-space>
            ...
            <el-button plain @click="handleFile">文件上传</el-button>
      ...
      >
        ...
        <el-table-column label="文件名" prop="name" width="220" show-overflow-tooltip />
        <el-table-column label="文件预览" prop="url" width="150" align="center" show-overflow-tooltip>
          <template #default="scope">
            <el-image
              fit="cover"
              :key="scope.row.ossId"
              v-if="preview && isImageFile(scope.row.url)"
              :src="scope.row.url"
        ...
        <el-table-column label="文件原名" prop="name" />
        ...
        <el-table-column label="操作" align="center" width="86" class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="listItemDelete(state, scope.row.ossId)" />
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
