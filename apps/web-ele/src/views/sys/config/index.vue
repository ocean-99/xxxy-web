  ...
  <Page auto-content-height>
    <el-card class="box-card" style="height: 100%" body-style="height: 100%">
      ...
      >
        ...
        <el-table-column label="参数键名" prop="kenam" />
        <el-table-column label="参数键值" prop="keval" />
        <el-table-column label="是否内置" prop="intag" width="86" align="center">
          <template #default="scope">
            <el-tag :type="scope.row.intag ? 'primary' : 'danger'">{{ scope.row.intag ? '是' : '否' }}</el-tag>
          </template>
        </el-table-column>
