      ...
      <el-card style="height: 100%" body-style="height: 100%" class="box-card flex-1 overflow-hidden">
        <template #header>
          <div class="flex justify-between">
            <el-space>
              <el-input style="width: 180px" v-model="state.form.name" placeholder="输入公司名称回车查询" clearable @keyup.enter="listQuery(state)" />
        ...
        >
          ...
          <el-table-column label="公司名称" align="center" prop="name" width="180">
