...
const initTreeData = async () => {
  state.data = await requestClient.get('/sys/org/dept/tree');
};
...
const handleDrop = async (draggingNode: any, dropNode: any, dropType: any, ev: any) => {
  await requestClient.post('/sys/org/dept/move', {
    type: dropType,
...
const deleteCate = async () => {
  await requestClient.delete(`/sys/org/dept/${currNode.id}`);
      ...
      <div class="card-header">
        <div class="tree-h-flex">
          <div class="tree-h-left">
            <div>
              <el-input prefix-icon="Search" v-model="filterText" placeholder="部门信息 可拖拽可右键" />
            </div>
          </div>
              ...
              <el-dropdown @command="handleCommand">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item command="rootNode">根部门</el-dropdown-item>
