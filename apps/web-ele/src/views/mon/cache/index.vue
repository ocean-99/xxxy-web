...
const getList = async () => {
  ...
  cache.value = await requestClient.get('/mon/cache').catch(() => {
    loading.close();
  });
    ...
    <div class="app-container" style="overflow: hidden">
      <el-row :gutter="8">
        <el-col :span="24">
          <el-card>
            <template #header>
              <Monitor style="width: 1em; height: 1em; vertical-align: middle; display: inline-block" />
        ...
        <el-col :span="12">
          <el-card class="card-box" style="margin-top: 8px">
            <template #header>
              <PieChart style="width: 1em; height: 1em; vertical-align: middle; display: inline-block" />
        ...
        <el-col :span="12">
          <el-card class="card-box" style="margin-top: 8px">
            <template #header>
              <Odometer style="width: 1em; height: 1em; vertical-align: middle; display: inline-block" />
